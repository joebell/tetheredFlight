// Flips between two odors randomly
// nb. Assigns olf1 to laser pin, olf2 to olfsig pin
...
#define ODOR1PROB 150        // Byte from 0 (0%) to 200 (100%)
#define MAXODORDURATION 5000000 // Odor lockout time in microseconds     
...
{  
   ...
   // Setup Random Odor Switcher
   currentOdor = 1;
   odorElapsed = 0;
   lastTimePoint = micros();
   lockedOut = false;
   randomSeed(analogRead(LAMPPIN));  // Seed on an analog value
