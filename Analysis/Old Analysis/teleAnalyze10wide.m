...
comment = '3oct @ -4, 0 sec delay';

fileList = { ...
 %   ['RTTF110728-163535.mat'],...
 %   ['RTTF110729-130030.mat'],...
 %   ['RTTF110729-132957.mat'],...
%      ['RTTF110729-140036.mat'],...
%      ['RTTF110729-152818.mat'],...
%      ['RTTF110729-160516.mat'],...
%     ['RTTF110802-140342.mat'],...
%     ['RTTF110802-141953.mat'],...
%    ['RTTF110802-145520.mat'],....
% ['RTTF110802-160418.mat'],...
% ['RTTF110802-162026.mat'],...
% ['RTTF110802-170824.mat'],...
% ['RTTF110802-172429.mat'],...
% ['RTTF110802-175320.mat'],...

['RTTF110803-110326.mat'],...
['RTTF110803-111940.mat'],...
['RTTF110803-122751.mat'],...
['RTTF110803-124406.mat'],...
['RTTF110803-131319.mat'],...
['RTTF110803-134052.mat'],...
['RTTF110803-140917.mat'],...
['RTTF110803-142532.mat'],...
['RTTF110803-153622.mat'],...
...
for i=1:size(fileList,2)
    ...
    for subFig = 3:5
        ...
        if subFig == 1
            traces1 = padcat(1,traces1, traces);
        elseif subFig == 2
            traces2 = padcat(1,traces2, traces);
        elseif subFig == 3
            traces3 = padcat(1,traces3, traces);
        elseif subFig == 4
            traces4 = padcat(1,traces4, traces);   
        elseif subFig == 5
            traces5 = padcat(1,traces5, traces); 
        end
    ...
    if size(fileList,2) == 1
        ...
        preTitle = ['Tele10-Crunch - ',comment];
    end
...
%     fill(X, Y, [1 .5 .5],'EdgeColor','none','FaceAlpha',.5);                
    xlabel('Time (sec)');
        ...
        if size(fileList,2) == 1
            ...
            filenameOut = ['Crunch-',comment,'-Tele10.pdf'];
        end
