function analyzeProbeBoxExtent()
...
%         SinFourier{i,subFig} = aFourier;
    ...
    if size(fileList,2) == 1
        ...
        preTitle = ['probeBoxExtent-Crunch - ',comment];
    end
    ...
    for heightN = 1:7
        ...
        title(['Box extent: ',num2str(heightList(heightN))]);
    end
        ...
        for metric = 1:9
            for i=1:size(fileList,2)
                ...
                set(gca,'XTick',1:8,...
                    'XTickLabel',{'Bar','2','6','8','12','16','20','24'}); 
...
%         xlabel('Period (s)');
        ...
        if size(fileList,2) == 1
            ...
            filenameOut = ['probeBoxExtent-Crunch-',comment,'-2.pdf'];
        end
        print(gcf, '-dpdf',[settings.dataDir,filenameOut]);
