function analyzeProbeBoxSize()

settings = tfSettings();

comment = 'test fly box size';

fileList = { ...
        ['RTTF110823-131733.mat'],...
        ['RTTF110823-142927.mat'],...
        ['RTTF110823-151738.mat'],...
        ['RTTF110823-160500.mat'],...
        ['RTTF110826-100517.mat'],...
        ['RTTF110826-104726.mat'],...
        ['RTTF110826-121628.mat'],...
        ['RTTF110826-130400.mat'],...
        ['RTTF110826-134801.mat'],...
        ['RTTF110826-143318.mat'],...
        ['RTTF110826-152032.mat'],...
};
...
%         SinFourier{i,subFig} = aFourier;
    ...
    if size(fileList,2) == 1
        ...
        preTitle = ['probeBoxSize-Crunch - ',comment];
    end
    ...
    for heightN = 1:7
        ...
        if size(fileList,2) == 1
            ...
            filenameOut = ['probeBoxSize-Crunch-',comment,'-1.pdf'];
        end
        ...
        for metric = 1:9
            for i=1:size(fileList,2)
                ...
                set(gca,'XTick',1:8,...
                    'XTickLabel',{'Bar','2','4','6','8','10','12','14'}); 
...
%         xlabel('Period (s)');
        ...
        if size(fileList,2) == 1
            ...
            filenameOut = ['probeBoxSize-Crunch-',comment,'-2.pdf'];
        end
        print(gcf, '-dpdf',[settings.dataDir,filenameOut]);
