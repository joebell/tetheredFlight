...
trialStructureList = [...
    {0,         visStimN,           LaserOff, olfOff, olfOff, olfOff, ['ardSetBox(6,32,1);',colorsOn]};...     %nb. First line is initial settingss
...
for epoch=1:7
    ...
    boxSet = ['ardSetBox(6,',num2str(height),',',num2str(21-height/2),');',colorsOn];
    stripeSet = ['ardSetBox(6,32,1);',colorsOn];
